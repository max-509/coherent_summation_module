    ...
    for (std::ptrdiff_t i = 0; i < sources_count; ++i) {
        for (std::ptrdiff_t r_ind = 0; r_ind < n_rec - (n_rec % vector_dim); r_ind += vector_dim) {
            ...
            __m256 ampl_vect = _mm256_mul_ps(tensor_matrix_v[2],
                                             _mm256_mul_ps(norm_coord_z, _mm256_mul_ps(coord_vec[2], coord_vec[2])));
            ...
            ampl_vect = _mm256_add_ps(ampl_vect, _mm256_mul_ps(tensor_matrix_v[3], _mm256_mul_ps(double_norm_coord_z,
                                                                                                 _mm256_mul_ps(
                                                                                                         coord_vec[1],
                                                                                                         coord_vec[2]))));
            ampl_vect = _mm256_add_ps(ampl_vect, _mm256_mul_ps(tensor_matrix_v[4], _mm256_mul_ps(double_norm_coord_z,
                                                                                                 _mm256_mul_ps(
                                                                                                         coord_vec[0],
                                                                                                         coord_vec[2]))));
            ampl_vect = _mm256_add_ps(ampl_vect, _mm256_mul_ps(tensor_matrix_v[5], _mm256_mul_ps(double_norm_coord_z,
                                                                                                 _mm256_mul_ps(
                                                                                                         coord_vec[0],
                                                                                                         coord_vec[1]))));
#endif
            ...
            _mm256_storeu_ps(&amplitudes_(i, r_ind), _mm256_div_ps(ampl_vect,
                                                                   _mm256_add_ps(_mm256_and_ps(ampl_vect, abs_mask_f),
                                                                                 f_epsilon_v)));
        }
    }
    ...
    for (std::ptrdiff_t i = 0; i < sources_count; ++i) {
        for (std::ptrdiff_t r_ind = 0; r_ind < n_rec - (n_rec % vector_dim); r_ind += vector_dim) {
            ...
            __m256d ampl_vect = _mm256_mul_pd(tensor_matrix_v[2],
                                              _mm256_mul_pd(norm_coord_z, _mm256_mul_pd(coord_vec[2], coord_vec[2])));
            ...
            ampl_vect = _mm256_add_pd(ampl_vect, _mm256_mul_pd(tensor_matrix_v[3], _mm256_mul_pd(double_norm_coord_z,
                                                                                                 _mm256_mul_pd(
                                                                                                         coord_vec[1],
                                                                                                         coord_vec[2]))));
            ampl_vect = _mm256_add_pd(ampl_vect, _mm256_mul_pd(tensor_matrix_v[4], _mm256_mul_pd(double_norm_coord_z,
                                                                                                 _mm256_mul_pd(
                                                                                                         coord_vec[0],
                                                                                                         coord_vec[2]))));
            ampl_vect = _mm256_add_pd(ampl_vect, _mm256_mul_pd(tensor_matrix_v[5], _mm256_mul_pd(double_norm_coord_z,
                                                                                                 _mm256_mul_pd(
                                                                                                         coord_vec[0],
                                                                                                         coord_vec[1]))));
#endif
            ...
            _mm256_storeu_pd(&amplitudes_(i, r_ind), _mm256_div_pd(ampl_vect,
                                                                   _mm256_add_pd(_mm256_and_pd(ampl_vect, abs_mask_d),
                                                                                 d_epsilon_v)));
        }
    }

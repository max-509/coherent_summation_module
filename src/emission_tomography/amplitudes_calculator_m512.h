    ...
    for (std::ptrdiff_t i = 0; i < sources_count; ++i) {
        for (std::ptrdiff_t r_ind = 0; r_ind < n_rec - (n_rec % vector_dim); r_ind += vector_dim) {
            ...
            __m512 ampl_vect = _mm512_mul_ps(tensor_matrix_v[2],
                                             _mm512_mul_ps(norm_coord_z, _mm512_mul_ps(coord_vec[2], coord_vec[2])));
            ...
            ampl_vect = _mm512_fmadd_ps(tensor_matrix_v[3],
                                        _mm512_mul_ps(double_norm_coord_z, _mm512_mul_ps(coord_vec[1], coord_vec[2])),
                                        ampl_vect);
            ampl_vect = _mm512_fmadd_ps(tensor_matrix_v[4],
                                        _mm512_mul_ps(double_norm_coord_z, _mm512_mul_ps(coord_vec[0], coord_vec[2])),
                                        ampl_vect);
            ampl_vect = _mm512_fmadd_ps(tensor_matrix_v[5],
                                        _mm512_mul_ps(double_norm_coord_z, _mm512_mul_ps(coord_vec[0], coord_vec[1])),
                                        ampl_vect);
    ...
    for (std::ptrdiff_t i = 0; i < sources_count; ++i) {
        for (std::ptrdiff_t r_ind = 0; r_ind < n_rec - (n_rec % vector_dim); r_ind += vector_dim) {
            ...
            __m512d ampl_vect = _mm512_mul_pd(tensor_matrix_v[2],
                                              _mm512_mul_pd(norm_coord_z, _mm512_mul_pd(coord_vec[2], coord_vec[2])));
            ...
            ampl_vect = _mm512_fmadd_pd(tensor_matrix_v[3],
                                        _mm512_mul_pd(double_norm_coord_z, _mm512_mul_pd(coord_vec[1], coord_vec[2])),
                                        ampl_vect);
            ampl_vect = _mm512_fmadd_pd(tensor_matrix_v[4],
                                        _mm512_mul_pd(double_norm_coord_z, _mm512_mul_pd(coord_vec[0], coord_vec[2])),
                                        ampl_vect);
            ampl_vect = _mm512_fmadd_pd(tensor_matrix_v[5],
                                        _mm512_mul_pd(double_norm_coord_z, _mm512_mul_pd(coord_vec[0], coord_vec[1])),
                                        ampl_vect);

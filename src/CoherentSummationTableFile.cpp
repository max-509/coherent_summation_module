...
CoherentSummationTableFile::CoherentSummationTableFile(const std::string &times_table_filename, std::size_t n_points)
        : time_arrival_nn_(times_table_filename, n_points) {}

py_array_d
CoherentSummationTableFile::emission_tomography_method(py_array_d gather,
...
CoherentSummationTableFile::~CoherentSummationTableFile() noexcept = default;

...
private:
	...
	void non_vector_calculate_amplitudes(ptrdiff_t ind_first_rec, const Array2D<T> &sources_coords, const Array2D<T> &rec_coords, const T *RESTRICT tensor_matrix, Array2D<T> &amplitudes) {
        ...
        #pragma omp parallel shared(n_rec, sources_count)
        {

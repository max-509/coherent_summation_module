#ifndef _EMISSION_TOMOGRAPHY_METHOD_CYCLES_REVERSES_H
#define _EMISSION_TOMOGRAPHY_METHOD_CYCLES_REVERSES_H
...
void emissionTomographyMethodCyclesReverses(const Array2D<T1> &gather,
...
#endif //_EMISSION_TOMOGRAPHY_METHOD_CYCLES_REVERSES_H
...
#include "array2D.h"
#include "emission_tomography_method_with_vectorization.h"
...
//	std::vector<std::size_t> times(5);
	emissionTomographyMethodWithVectorization(gather, receivers_coords, sources_coords, sources_receivers_times, dt, tensor_matrix, result_data);

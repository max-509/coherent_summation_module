...
private:
    ...
    void non_vector_calculate_amplitudes(std::ptrdiff_t ind_first_rec, const Array2D<T> &sources_coords,
                                         const Array2D<T> &rec_coords, const T *tensor_matrix, Array2D<T> &amplitudes) {

...
//	measurements_file << std::endl;
	...
	measurements_file << NxR*NyR << ";";
	measurements_file << data_gen.get_n_samples() << ";";
	run_program(kirchhoffMigrationCHG3DNativeVect<double, double>,
	        data_gen,
	        measurements_file,
	        x0_r, x1_r, NxR,
	        y0_r, y1_r, NyR,
	...
	measurements_file << NxR*NyR << ";";
	measurements_file << data_gen.get_n_samples() << ";";
	run_program(std::bind(kirchhoffMigrationCHG3DNativeBlocks<double, double>,
	        std::placeholders::_1,
	        std::placeholders::_2,
	        std::placeholders::_3,
	        std::placeholders::_4,
	...
	measurements_file << NxR*NyR << ";";
	measurements_file << data_gen.get_n_samples() << ";";
	run_program(kirchhoffMigrationCHG3DNativeAutoVect<double, double>,
	        data_gen,
	        measurements_file,
	        x0_r, x1_r, NxR,
	        y0_r, y1_r, NyR,
